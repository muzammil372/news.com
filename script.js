      ...
      <div class="news-card small">
        <div class="image-wrapper">
          ...
          <div class="share-icons">
             <a href="https://wa.me/?text=${encodeURIComponent(news.title + '%0A%0A' + (news.summary || 'پڑھیں تازہ ترین خبر') + '%0A%0A' + window.location.origin + '/news.html?slug=' + news.slug)}" target="_blank" title="Share on WhatsApp" aria-label="Share on WhatsApp">
